...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `qwen/qwen3-coder` | Agent orchestration benchmark runs and private scenario scoring. |
...
OPENROUTER_HTTP_REFERER=https://agent-orchestration-benchmark.pages.dev
OPENROUTER_APP_TITLE=agent-orchestration-benchmark
```
