# Service Growth Model - agent-orchestration-benchmark
...
| Field | Decision |
|---|---|
| Service type | Framework selection and benchmark governance |
| Primary reader or buyer | Engineering leads selecting agent frameworks. |
| Wedge | Framework selection review with reproducible benchmark packet. |
